...
$route = $price_conv = types_render_field( 'ruta' );
?>
<div class="container">
            ...
            <div class="col-md-12">
                <ul class="nav nav-tabs">
                    ...
                    <?php if ( !empty( $gallery ) ): ?>
                        <li role="presentation" <?php if ( empty( $includes ) ): ?>class="active"<?php endif; ?>><a
                                    href="#gallery">Images Gallery</a></li>
                    <?php endif; ?>
                </ul>
                <div class="tab-content">
                    ...
                    <?php if ( !empty( $gallery ) ): ?>
                        <div id="gallery"
                             class="tab-pane fade <?php if ( empty( $includes ) ): ?>active<?php endif; ?> in pt-25">
                            <?php
